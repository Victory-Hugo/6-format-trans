...
# ================== 配置参数 ==================
VCF_PATH="/home/luolintao/0_现代DNA处理流程/output/Archive/merged_clean_remmove_hots.vcf.gz"
OUT_PREFIX="/home/luolintao/0_现代DNA处理流程/output/Archive/merged_clean_remmove_hots"
