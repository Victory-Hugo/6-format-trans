...
# ================== 配置参数 ==================
VCF_PATH="/mnt/f/0_现代DNA处理流程/output/Archive/merged_filtered_去除hots.vcf.gz"
OUT_PREFIX="/mnt/f/0_现代DNA处理流程/output/Archive/merge_fasta/merged_filtered_anno_去除hots"
